...
Trafikverket.prototype.getRoadConditionsByName = function (roadNumber) {
    var self = this;
...
Trafikverket.prototype.getRoadConditionsByLocation = function (lat, long, radius) {
    var self = this;
...
Trafikverket.prototype.getRoadConditionDetails = function (conditionId) {
    var self = this;
...
Trafikverket.prototype.getImageURLForWeatherStation = function (stationName) {
    var self = this;
